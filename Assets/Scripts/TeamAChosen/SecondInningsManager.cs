...
public class SecondInningsManager : MonoBehaviour
{
    int maxOvers;
    int maxOversPerBowler;
    int totalOversBowled, chasingTeamTotal, totalWickets;
    ...
    void Start()
    {
        ...
        int tot = FIrstInningsManager.battingTeamTotal + 1;
    ...
    void Update()
    {
        ...
        if(Input.GetKeyDown(KeyCode.Space) && inningsComplete) {
            if(deliveriesThisOver == 6) {
                ...
                if(chasingTeamTotal > FIrstInningsManager.battingTeamTotal) {
                    ...
                    int runsLeft = FIrstInningsManager.battingTeamTotal - chasingTeamTotal;
    ...
    void BowlDelivery() {
        ...
        if(totalOversBowled == maxOvers || totalWickets == 10 || chasingTeamTotal > FIrstInningsManager.battingTeamTotal) {
        ...
        if(deliveriesThisOver < 6) {
            int num1  = FIrstInningsManager.battingTeamTotal + 1 - chasingTeamTotal;
            if(num1 < 0) {
                num1 = 0;
            }
