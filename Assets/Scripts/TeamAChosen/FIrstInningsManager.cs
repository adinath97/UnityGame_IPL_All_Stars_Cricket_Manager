...
public class FIrstInningsManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(Input.GetKeyDown(KeyCode.Space) && inningsComplete) {
            if(deliveriesThisOver == 6) {
                ...
                InningsBreakManager.chasePreview = "Team North needs " + total.ToString() + " runs in " + deliveriesTotal.ToString() + " balls to win.";
                InningsBreakManager.nextSceneName = "TeamBChasingTeamAChosen";
