...
public class TeamABatsFirstTeamBChosen : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(Input.GetKeyDown(KeyCode.Space) && inningsComplete) {
            if(deliveriesThisOver == 6) {
                GameOverManager.firstInningsText = "Team South: " + battingTeamTotal.ToString() + " / " + totalWickets.ToString() + " in " + totalOversBowled.ToString() + ".0 overs";
                InningsBreakManager.firstInningSummary = "Team South: " + battingTeamTotal.ToString() + " / " + totalWickets.ToString() + " in " + totalOversBowled.ToString() + ".0 overs";
                int total = battingTeamTotal + 1;
                int totalDeliveries = maxOvers * 6;
                InningsBreakManager.chasePreview = "Team North needs " + total.ToString() + " runs in " + totalDeliveries.ToString() + " balls to win.";
                InningsBreakManager.nextSceneName = "TeamBChasingTeamBChosen";
                SceneManager.LoadScene("InningsBreakScene");
            }
            else {
                GameOverManager.firstInningsText = "Team South: " + battingTeamTotal.ToString() + " / " + totalWickets.ToString() + " in " + totalOversBowled.ToString() + "." + deliveriesThisOver.ToString() + " overs";
                InningsBreakManager.firstInningSummary = "Team South: " + battingTeamTotal.ToString() + " / " + totalWickets.ToString() + " in " + totalOversBowled.ToString() + "." + deliveriesThisOver.ToString() + " overs";
                int total = battingTeamTotal + 1;
                int totalDeliveries = maxOvers * 6;
                InningsBreakManager.chasePreview = "Team North needs " + total.ToString() + " runs in " + totalDeliveries.ToString() + " balls to win.";
                InningsBreakManager.nextSceneName = "TeamBChasingTeamBChosen";
